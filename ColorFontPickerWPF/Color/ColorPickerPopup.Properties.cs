...
namespace ColorFontPickerWPF
{
    public partial class ColorPickerPopup
    {
        ...
        public static readonly DependencyProperty ColorTextProperty = DependencyProperty.Register(nameof(ColorText), typeof(ColorTextFormat), typeof(ColorPickerPopup), new FrameworkPropertyMetadata(ColorTextFormat.None, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
        ...
        public static readonly DependencyProperty SelectedColorProperty = DependencyProperty.Register(nameof(SelectedColor), typeof(Color), typeof(ColorPickerPopup), new FrameworkPropertyMetadata(Colors.Transparent, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, SelectionChangedEvent));
        /// <summary>
